...
if __name__ == "__main__":
    ...
    # virtualkss start
    import pprint
    pprint.pprint(env.env._observables)
    target_obs_name = 'robot0_joint_pos_cos'
    pprint.pprint(env.env._observables[target_obs_name].is_enabled())
    env.env.modify_observable(target_obs_name, 'enabled', False)
    env.env.modify_observable(target_obs_name, 'active', False)
    pprint.pprint(env.env._observables)
    pprint.pprint(env.env._observables[target_obs_name].is_enabled())
